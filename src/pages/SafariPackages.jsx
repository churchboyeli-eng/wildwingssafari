  ...
  return (
    <div className="safari-site">
      ...
      <main id="top">
        ...
        <section className="zanzibar-hero" aria-labelledby="zanzibar-heading"><div className="hero-grid" aria-hidden="true"><span /><span /><span /><span /><span /></div><div className="hero-copy"><p className="section-kicker">From Zanzibar to the wilderness</p><h2 id="zanzibar-heading">Tanzania safari<br />from Zanzibar</h2><p>Discover Serengeti, Ngorongoro Crater, Tarangire and more with a direct safari connection from the coast.</p><div className="hero-actions"><a href="#contact" className="quote-button">Get a free quote <ArrowRight aria-hidden="true" size={17} /></a><a href={waHref} target="_blank" rel="noopener noreferrer" className="hero-whatsapp"><MessageCircle aria-hidden="true" size={18} /> WhatsApp us</a></div></div><a className="scroll-cue" href="#destinations" aria-label="Scroll to destinations"><ArrowDown aria-hidden="true" size={19} /></a></section>
