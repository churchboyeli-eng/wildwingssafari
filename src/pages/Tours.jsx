  ...
  return (
    <div className="page-enter itinerary-listing-page">
      <section className={`itinerary-listing-hero ${activeCategory?.key === 'safaris' ? 'is-safari-hero' : ''}`} aria-labelledby="itinerary-listing-heading">
        {activeCategory?.key === 'safaris' && <img className="itinerary-listing-hero-image" src={safariMedia.fieldMigrationPlains.src} alt={safariMedia.fieldMigrationPlains.alt} fetchPriority="high" decoding="async" />}
